...
**Note:** if you want the virtual environment to be stored somewhere else, you
can set its path as the environment variable `ALTDOC_VENV`, e.g.
`Sys.setenv(ALTDOC_VENV = "/opt/venv/altdoc")`.
